...
SELECT YEAR(date_de_sortie) AS date, titre, g.libelle AS genre, r.prenom AS prenom, r.nom AS nom, f.id AS id FROM film f
...
foreach ($film as $films) {
    echo "<ul><li><a href='film.php?id_film=$films->id'>$films->titre</a> ($films->genre de $films->prenom $films->nom, $films->date)</li></ul>";
}
